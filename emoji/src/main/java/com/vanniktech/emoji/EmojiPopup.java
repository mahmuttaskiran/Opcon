...
public final class EmojiPopup {
    ...
    EmojiPopup(@NonNull final View rootView, @NonNull final EmojiEditText emojiEditText, @Nullable final RecentEmoji recent) {
        ...
        emojiView = new EmojiView(context, new OnEmojiClickedListener() {
            @Override
    ...
    public void setEmojiPagerScroolListener(EmojiPagerScrollListener emojiPagerScroolListener) {
        this.emojiView.setEmojiPagerListener(emojiPagerScroolListener);
    }

    public int getStartIndex() {
        return emojiView.getStartIndex();
    }

    public void setPage(int pageIndex) {
        this.emojiView.setPageIndex(pageIndex);
    }

    public interface EmojiPagerScrollListener {
        void onScroll(int pageIndex);
    }
